...
Installed Cursor IDE from the official website.
Opened Cursor and accessed the Extensions panel.
Searched for and installed:
Claude Code
Codex
Created a new public repository on GitHub.
Cloned/opened the repository inside Cursor.
Created a README.md file.
Added documentation for the setup process.
Committed changes and pushed the repository to GitHub.
...
Next Steps
Explore more advanced features of Cursor and AI-assisted coding workflows.
Apply these tools to real-world projects beyond setup and documentation.
